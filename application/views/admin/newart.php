...
<head>
   ...
   <link href="<?php echo base_url('public/css/admin-newart.css') ?>" rel="stylesheet">
   <script src="<?php echo base_url('public/js/admin-newart.js') ?>"></script>
...
<nav id="left" class="navbar navbar-inverse" role="navigation">
   <ul class="nav nav-pills nav-stacked">
      ...
      <li id="btnNewArt" class="active"><a href="<?php echo base_url('index.php/admin/newart') ?>">新建文章</a></li>
   </ul>
</nav>
<div id="rightwrap">
   <div id="edit">
