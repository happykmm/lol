...
<head>
   ...
   <link href="<?php echo base_url('public/css/front-artdetail.css') ?>" rel="stylesheet">
</head>
<body>
   ...
   <div class="container">
     ...
     <div id="navbar" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px; ">
       <ul class="nav navbar-nav">
         <li><a href="<?php echo base_url('index.php/front/home') ?>">&nbsp;主&nbsp;页&nbsp;</a></li>
         <li class="active"><a href="<?php echo base_url('index.php/front/artlist') ?>">参赛作品</a></li>
